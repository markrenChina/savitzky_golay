            ...
            static EIGEN_STRONG_INLINE void run(Index size, Index depth, const LhsScalar *_lhs, Index lhsStride,
                ...
                for (Index k2 = 0; k2 < depth; k2 += kc) {
                    ...
                    for (Index i2 = 0; i2 < size; i2 += mc) {
                        ...
                        sybb(_res + resStride * i2 + resIncr * i2, resIncr, resStride, blockA, blockB + actual_kc * i2,
...
//   triangular traversal.
        ...
        struct tribb_kernel {
            ...
            void operator()(ResScalar *_res, Index resIncr, Index resStride, const LhsScalar *blockA,
                ...
                for (Index j = 0; j < size; j += BlockSize) {
                    ...
                    // selfadjoint micro block
                    {
                        ...
                        gebp_kernel2(BufferMapper(buffer.data(), BlockSize), blockA + depth * i, actual_b,
                                     actualBlockSize, depth, actualBlockSize, alpha,
                                     -1, -1, 0, 0);
    ...
    struct general_product_to_triangular_selector<MatrixType, ProductType, UpLo, false> {
        static void run(MatrixType &mat, const ProductType &prod, const typename MatrixType::Scalar &alpha, bool beta) {
            ...
            ::run(size, depth,
                  ...
                  mat.data() +
                  (SkipDiag ? (bool(IsRowMajor) != ((UpLo & Lower) == Lower) ? mat.innerStride() : mat.outerStride())
                            : 0),
